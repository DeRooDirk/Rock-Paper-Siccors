const moves = ["Rock ", "Paper ", "Scissors "],
    messages = ["John Conner wins! ✨", "Skynet wins 🧨", "It's a draw! 🎃"], // [Player, skynet, draw]
...
function game() {
    ...
    appel_result.innerHTML = `John Conner: ${moves[player]}<br>skynet: ${moves[skynet]}<br>${messages[result]}`;
